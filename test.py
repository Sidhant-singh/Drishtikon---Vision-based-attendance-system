...
with open('C:/Users/shrut/OneDrive/Desktop/9 Smart-Attendence-System/9 Smart-Attendence-System/Data/names.pkl', 'rb') as w:
...
while True:
    ...
    for (x, y, w, h) in faces:
        ...
        # Append the name to the LABELS list for each face captured
        # LABELS.append(name)
